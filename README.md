...
| --- | --- | --- |
| 问界 | M5、M6、M7、M8、M9 | **已接入**：M5（`SERES-X1`、`SERES-X1-23-H`、`SERES-X1-24-U`、`SERES-X1EV-24-C`）、M6（`AITO-A15`）、M7（`SERES-F1-24-H`、`SERES-F1-24-U`）、M8（`SERES-F3`）、M9（`SERES-F2`） |
| 享界 | S9、S9T、G9 | 未接入 |
| 智界 | S7、R7、V9 | **已接入**：R7（`EHY-REEV-2025MY`、`EHY-2025MY`、`EHY-2026MY1`） |
