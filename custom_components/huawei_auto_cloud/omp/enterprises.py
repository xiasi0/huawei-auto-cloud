...
SERES_BINDING = _binding(
    ...
    frozenset({"seres_f3", "seres_f2", "seres_aito_a15", "seres_x1", "seres_x1_23_h", "seres_x1_24_u", "seres_x1ev_24_c", "seres_f1_24_h", "seres_f1_24_u"}), _SERES_DISCOVERY, "2026-08-seres",
...
CHERY_BINDING = _binding(
    ...
    frozenset({"luxeed_r7", "luxeed_r7_2025_ev", "luxeed_r7_2026_ev"}), _VCAM_DISCOVERY, "2026-08-chery-runtime",
)
